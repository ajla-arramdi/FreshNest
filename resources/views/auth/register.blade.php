...
@section('title', 'Register - FreshNest')
...
<div class="auth-container">
    ...
    <div class="auth-header">
        ...
        <p class="auth-subtitle">Silakan daftar untuk memulai</p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-start">
                ...
                <label for="terms" class="ml-2 block text-sm text-gray-700">
                    Saya menyetujui <a href="#" class="text-green-600 hover:text-green-700 font-medium">Syarat & Ketentuan</a> dan <a href="#" class="text-green-600 hover:text-green-700 font-medium">Kebijakan Privasi</a>
                </label>
            </div>
